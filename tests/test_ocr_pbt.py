...
Feature: wine-photo-pipeline, Property 8: OCR text parsing extracts known embedded tokens
...
def test_embedded_token_is_found(token: str, before: str, after: str):
    """Property 8: When a known token is embedded in raw OCR text,
    _token_found identifies it.
...
def test_cross_reference_confirms_embedded_fields(
    ...
    """Property 8 (extended): _cross_reference confirms fields whose values
